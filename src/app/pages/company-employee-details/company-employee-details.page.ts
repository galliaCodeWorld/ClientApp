...
export class CompanyEmployeeDetailsPage {
	...
	set companyEmployee(value: CompanyEmployeeDto) {
      ...
      if (value?.member?.firstName) this.firstName = value.member.firstName;
      else this.firstName = "";
      if (value?.member?.lastName) this.lastName = value.member.lastName;
      else this.lastName = "";
      if (value?.member?.email) this.email = value.member.email;
      else this.email = "";
