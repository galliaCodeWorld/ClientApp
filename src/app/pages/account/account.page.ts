...
export class AccountPage {
	...
	async processImage(dataUri: string, accessToken: string): Promise<MemberType> {
		try {
	...
	async processEmail(email: string, accessToken: string): Promise<MemberType | null> {
		try {
