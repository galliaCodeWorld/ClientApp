...
export class SignalrService {
	...
	*/
	...
	async sendKeepAlive(email: string, connectionId: any): Promise<void> {
		try {
	...
	endWebRtcHubListeners(): void {
		...
		webRtcHub.off("receiveCancelInvitation");

		webRtcHub.off("receivePhoneLineInvitation");

		webRtcHub.off("receiveAcceptPhoneLineInvitation");

		webRtcHub.off("receiveAreYouReadyForCall");

		webRtcHub.off("receiveReadyForCall");

		webRtcHub.off("receiveNotReadyForCall");

		webRtcHub.off("receiveSDP");

		webRtcHub.off("receiveICE");

		webRtcHub.off("receiveBusyResponse");

		webRtcHub.off("receiveNotAcceptCall");

		webRtcHub.off("receiveRemoteLogout");

		webRtcHub.off("receivePutOnHold");

		webRtcHub.off("receiveRemoveOnHold");

		webRtcHub.off("receivePrivateSmsMessage");

		webRtcHub.off("receiveGroupSmsMessage");

		webRtcHub.off("receiveHangUpNotice");

		webRtcHub.off("receiveRepHangUpNotice");

		webRtcHub.off("receivePing");

		webRtcHub.off("receivePingResponse");

		webRtcHub.off("receiveSystemMessage");

		webRtcHub.off("receiveRequestNetcast");

		webRtcHub.off("receiveRequestPCOnly");

		webRtcHub.off("receiveRequestPCStream");

		// PBX
		webRtcHub.off("receivePbxPhoneLineInvitation");

		webRtcHub.off("receivePbxRepPhoneLineInvitation");

		webRtcHub.off("receivePbxCallQueueNotes");

		webRtcHub.off("receiveAddPbxCustomer");

		webRtcHub.off("receiveRemovePbxCustomer");

		webRtcHub.off("receiveNewPbxLineRep");

		webRtcHub.off("receiveDisconnect");

		webRtcHub.off("someoneDisconnected");

		webRtcHub.off("receiveNetcastStub");

		webRtcHub.off("receiveRequestNetcastStub");

		//webRtcHub.off("receiveAreYouOnlineResponse");

		//webRtcHub.off("receivePbxCallQueueOccupants");

		//webRtcHub.off("receivePbxCallQueueLineRepUpdate");
