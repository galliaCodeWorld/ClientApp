...
export class PbxService {
	...
	async createContactUs(model: ContactUsDto): Promise<ContactUsDto> {
		try {
			...
			let dto = await this.jsHelperService.ajaxRequestParsed<ContactUsDto>(HttpTypeEnum.post, url, payload, "");
			return dto;
		}
		catch (e) {
	...
	async getContactUsById(contactUsId: number): Promise<ContactUsDto> {
		try {
			...
			let dto = await this.jsHelperService.ajaxRequestParsed<ContactUsDto>(this.httpGet, url, payload, "");
			return dto;
		}
		catch (e) {
			throw (e);
