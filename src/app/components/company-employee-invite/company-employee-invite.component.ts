...
export class CompanyEmployeeInviteComponent {
		...
		if (this.inputCompanyEmployeeInvite.isAccepted) {
			this.service.getAccessToken()
				.then((accessToken: string) => {
					return this.service.getCompanyEmployeeByEmail(
            this.inputCompanyEmployeeInvite.email ? this.inputCompanyEmployeeInvite.email : "", this.service.companyProfile.companyProfileId!, accessToken);
				})
    ...
    this.dateAccepted = this.service.isEmpty(value.dateAccepted) ? "" : value.dateAccepted ? value.dateAccepted.toString() : "";
        ...
        : this.service.companyProfile.companyProfileId 
