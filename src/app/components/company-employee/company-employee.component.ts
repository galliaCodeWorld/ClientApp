...
export class CompanyEmployeeComponent {
	...
	set companyEmployee(value: CompanyEmployeeDto) {
      ...
      this.firstName = this.service.isEmpty(value.member) ? "" : value.member ? value.member.firstName : "";
      this.lastName = this.service.isEmpty(value.member) ? "" : value.member ? value.member.lastName : "";
      this.email = this.service.isEmpty(value.member) ? "" : value.member ? value.member.email : "";
