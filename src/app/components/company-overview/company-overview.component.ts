...
export class CompanyOverviewComponent implements OnInit {
  ...
  toggleEditMode(field: any) {
        console.log(field)
        this[field as keyof CompanyOverviewComponent] = !this[field as keyof CompanyOverviewComponent]
    }
    ...
    saveChanges() {
        ...
        if (this.canEditName || this.canEditDescription) {
          ...
          companyProfile.companyProfileId = this.companyProfileView.companyProfileId;
          companyProfile.memberId = this.companyProfileView.memberId;
          companyProfile.companyName = this.canEditName ? this.companyNameFormControl.value : this.companyProfileView.companyName;
          companyProfile.description = this.canEditDescription ? this.companyDescriptionFormControl.value : this.companyProfileView.description;


            this.pbxService.updateCompanyProfile(companyProfile, jwt.access_token)
                .then((data) => {
                    this.checkForCompany()
                })
                .catch((error) => {
